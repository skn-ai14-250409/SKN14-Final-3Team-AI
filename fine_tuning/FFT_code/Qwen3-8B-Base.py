...
# 🌟 WandB 설정
WANDB_PROJECT_NAME = "qwen3-8b-finance-full-finetune" # <--- 🙋‍♂️ WandB에 표시될 프로젝트 이름

# 모델 및 토크나이저 설정
BASE_MODEL_NAME = "unsloth/Qwen3-8B-Base" # <--- 🌟 모델 변경
MAX_SEQ_LENGTH = 1024
...
HUB_FULL_REPO = f"{HF_USERNAME}/qwen3-8b-finance-full"
HUB_GGUF_REPO = f"{HF_USERNAME}/qwen3-8b-finance-full-gguf"
...
if __name__ == "__main__":
    ...
    instruct_tokenizer = AutoTokenizer.from_pretrained("unsloth/Qwen3-8B")
